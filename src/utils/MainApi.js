...
const addFilmSaved = async (data) => {
  return fetch(`${URL}/movies`, {
    ...
    getResponseData(res, 'При добавлении в сохраненные фильм произошла ошибка. Попробуйте еще раз.')
  );
};
...
const removeFilmSaved = async (id) => {
  return fetch(`${URL}/movies/${id}`, {
    ...
    getResponseData(res, 'При удалении из сохраненных фильмов произошла ошибка. Попробуйте еще раз.')
  );
};
