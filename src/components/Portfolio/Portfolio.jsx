        ...
        <ul className="portfolio__list list">
          <li className="portfolio__item">
            <Link
              ...
              to="https://mvttsun.github.io/how-to-learn"
              target="_blank"
            >
          ...
          <li className="portfolio__item">
            <Link
              className="portfolio__link link"
              to="https://mvttsun.github.io/russian-travel"
              target="_blank"
            >
          ...
          <li className="portfolio__item">
            <Link className="portfolio__link link" to="https://mesto.mvtt.nomoredomains.xyz" target="_blank">
